...
void testSLLSetIntArray_2() {

        int arr[] = {1, 2, 3, 7, 8, 6, 9, 2}; // this list

        SLLSet listObj2 = SLLSet(arr,8);
        string expectedSet = "1, 2, 3, 7, 8, 6, 9, 2";
        int expectedSize = 8;
        ASSERT_EQUAL(expectedSize,listObj2.getSize());
        ASSERT_EQUAL(expectedSet,listObj2.toString());
	}
...
void testIsInTrue_2() {
    ...
    int arr[] = {1, 2, 3, 4, 9, 6, 7, 2, 3}; // this list
    SLLSet listObj2 =  SLLSet(arr,9);
...
void testIsInFalse_2() {

    int arr[] = {1, 2, 3, 7, 8, 9}; // this list
    SLLSet listObj2 =  SLLSet(arr,6);


        int notin = 4; // test isIn
        bool expected = false;
...
void testAdd1_2() {
    ...
    int arr[] = {1, 2, 4, 6, 5}; // this list
    SLLSet listObj2 =  SLLSet(arr,5);

        int notadd = 9;


        string expectedObj2 = "1, 2, 4, 6, 5, 9";
...
void testRemove2_2() {
    ...
    int arr[] = {1, 2, 3, 7, 8, 4, 7}; // this list
    SLLSet listObj2 =  SLLSet(arr,7);
        ...
        string expectedObj2 = "1, 2, 7, 8, 4, 7";
        int expectedObj2Size = 6;
...
bool runAllTests(int argc, char const *argv[]) {
	...
	s.push_back(CUTE(testSLLSetIntArray_2));
	s.push_back(CUTE(testIsInTrue_2));
	s.push_back(CUTE(testIsInFalse_2));
	s.push_back(CUTE( testAdd1_2));
	s.push_back(CUTE(testRemove1_2));
	s.push_back(CUTE(testRemove2_2));
