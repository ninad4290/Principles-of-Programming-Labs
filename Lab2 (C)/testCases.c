...
void TestQ1_norm1(CuTest *tc){
	int n = 5;
	double input1[5] = {1.10, 1.20, 1.50, 10.00, 1.00};
	double input2[5] = {1.00, 2.00, 2.00, 4.20, 1.00};
...
void TestQ2_true_neg1(CuTest *tc) {

	int input[3][3] = {{-7, 2, 1}, {6, 2, 0}, {3, 5, 2}};
	int actual = is_diag_dom(input);
	int expected = 0;
	CuAssertIntEquals(tc, expected, actual);
}
...
void TestQ3_1(CuTest *tc) {
	int n = 3;
	int input[3][3] = {{1, 7, 1},{ 3, 4, 7},{ 1, 3, 0}};
	int expected[9]= {1, 3, 7, 1, 4, 1, 3, 7, 0};
	int actual[9];
	diag_scan(input,actual);
...
CuSuite* Lab2GetSuite() {
	...
	SUITE_ADD_TEST(suite, TestQ2_true_neg1);
